...
import kr.co.seoulit.erp.logi.logistics.sales.dao.SalesPlanDAO;
	...
	public HashMap<String, Object> convertContractDetailToMps(
		...
		HashMap<String, Object> resultMap = null;
			...
			// MPS 에 등록할 수주상세 Bean 의 정보를 새로운 MPS Bean 에 세팅, status : "INSERT"
				...
				System.out.println("convertContractDetailToMps ApplicationServiceImpl접근----------------------------"+contractDetailInMpsAvailableTO.getContractDetailNo());
